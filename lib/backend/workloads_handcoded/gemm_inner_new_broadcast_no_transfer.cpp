...
int32_t gemm_inner_new_broadcast_no_transfer(System* sys){
...
static __attribute__((unused)) Registry::Entry &__gemm_inner_new_broadcast_no_transfer__ = pimsim::registerFunc("gemm_inner_new_broadcast_no_transfer", gemm_inner_new_broadcast_no_transfer);