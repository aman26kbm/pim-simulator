...
int32_t vadd_no_transfer(System* sys){
...
static __attribute__((unused)) Registry::Entry &__vadd_no_transfer__ = pimsim::registerFunc("vadd_no_transfer", vadd_no_transfer);
