...
int32_t gemm_systolic_int6(System* sys, std::string params){
...
static __attribute__((unused)) Registry::Entry &__gemm_systolic_int6__ = pimsim::registerFunc("gemm_systolic_int6", gemm_systolic_int6);