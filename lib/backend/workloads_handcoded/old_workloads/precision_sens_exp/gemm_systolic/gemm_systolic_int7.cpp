...
int32_t gemm_systolic_int7(System* sys, std::string params){
...
static __attribute__((unused)) Registry::Entry &__gemm_systolic_int7__ = pimsim::registerFunc("gemm_systolic_int7", gemm_systolic_int7);