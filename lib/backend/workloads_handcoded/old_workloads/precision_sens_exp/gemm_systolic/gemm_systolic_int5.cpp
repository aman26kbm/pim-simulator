...
int32_t gemm_systolic_int5(System* sys, std::string params){
...
static __attribute__((unused)) Registry::Entry &__gemm_systolic_int5__ = pimsim::registerFunc("gemm_systolic_int5", gemm_systolic_int5);