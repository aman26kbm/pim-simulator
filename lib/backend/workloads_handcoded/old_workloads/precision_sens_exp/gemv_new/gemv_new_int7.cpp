...
int32_t gemv_new_int7(System* sys, std::string param)
{
    ...
    PrecisionT::Precision input_precision = PrecisionT::Precision{0, 7, 0};
    PrecisionT::Precision multiply_precision = PrecisionT::Precision{0, 14, 0};
    PrecisionT::Precision accumulate_precision = PrecisionT::Precision{0, 28, 0};
...
static __attribute__((unused)) Registry::Entry &__gemv_new_int7__ = pimsim::registerFunc("gemv_new_int7", gemv_new_int7);
