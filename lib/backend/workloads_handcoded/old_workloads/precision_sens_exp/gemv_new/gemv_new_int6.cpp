...
int32_t gemv_new_int6(System* sys, std::string param)
{
    ...
    PrecisionT::Precision input_precision = PrecisionT::Precision{0, 6, 0};
    PrecisionT::Precision multiply_precision = PrecisionT::Precision{0, 12, 0};
    PrecisionT::Precision accumulate_precision = PrecisionT::Precision{0, 24, 0};
...
static __attribute__((unused)) Registry::Entry &__gemv_new_int6__ = pimsim::registerFunc("gemv_new_int6", gemv_new_int6);
