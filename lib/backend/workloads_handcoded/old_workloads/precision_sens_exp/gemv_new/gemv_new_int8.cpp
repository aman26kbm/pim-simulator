...
int32_t gemv_new_int8(System* sys, std::string param)
{
    ...
    PrecisionT::Precision input_precision = PrecisionT::Precision{0, 8, 0};
    PrecisionT::Precision multiply_precision = PrecisionT::Precision{0, 16, 0};
    PrecisionT::Precision accumulate_precision = PrecisionT::Precision{0, 32, 0};
...
static __attribute__((unused)) Registry::Entry &__gemv_new_int8__ = pimsim::registerFunc("gemv_new_int8", gemv_new_int8);
