...
int32_t gemv_new_int5(System* sys, std::string param)
{
    ...
    PrecisionT::Precision input_precision = PrecisionT::Precision{0, 5, 0};
    PrecisionT::Precision multiply_precision = PrecisionT::Precision{0, 10, 0};
    PrecisionT::Precision accumulate_precision = PrecisionT::Precision{0, 20, 0};
...
static __attribute__((unused)) Registry::Entry &__gemv_new_int5__ = pimsim::registerFunc("gemv_new_int5", gemv_new_int5);
