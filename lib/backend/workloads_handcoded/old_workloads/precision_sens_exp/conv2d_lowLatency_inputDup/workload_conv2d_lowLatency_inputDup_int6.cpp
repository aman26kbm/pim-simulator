...
int32_t conv2d_lowLatency_inputDup_int6(System* sys, std::string param_file)
{
    ...
    PrecisionT::Precision precision_input = PrecisionT::Precision{0, 6, 0};
    PrecisionT::Precision precision_multiply = PrecisionT::Precision{0, 12, 0};
    PrecisionT::Precision precision_accumulate = PrecisionT::Precision{0, 24, 0};
    ...
    //load input
    conv2d_low_latency_load_input_dup(conv_layer_params, precision_input, precision_multiply, precision_accumulate, requests, sys);
    //start compute
    conv2d_low_latency_compute_input_dup(conv_layer_params, precision_input, precision_multiply, precision_accumulate, requests, sys);
    //store output
    conv2d_low_latency_store_input_dup(conv_layer_params, precision_input, precision_multiply, precision_accumulate, requests, sys);
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_int6__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_int6", conv2d_lowLatency_inputDup_int6);
