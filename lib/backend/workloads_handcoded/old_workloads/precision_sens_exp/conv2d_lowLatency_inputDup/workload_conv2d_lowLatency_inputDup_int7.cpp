...
int32_t conv2d_lowLatency_inputDup_int7(System* sys, std::string param_file)
{
    ...
    PrecisionT::Precision precision_input = PrecisionT::Precision{0, 7, 0};
    PrecisionT::Precision precision_multiply = PrecisionT::Precision{0, 14, 0};
    PrecisionT::Precision precision_accumulate = PrecisionT::Precision{0, 28, 0};
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_int7__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_int7", conv2d_lowLatency_inputDup_int7);
