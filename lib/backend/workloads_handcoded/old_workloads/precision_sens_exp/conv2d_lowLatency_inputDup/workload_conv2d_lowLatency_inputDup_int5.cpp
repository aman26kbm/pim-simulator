...
int32_t conv2d_lowLatency_inputDup_int5(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_int5__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_int5", conv2d_lowLatency_inputDup_int5);
