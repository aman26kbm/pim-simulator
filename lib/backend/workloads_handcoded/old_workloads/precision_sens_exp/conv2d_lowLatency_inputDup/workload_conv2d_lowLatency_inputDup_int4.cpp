...
int32_t conv2d_lowLatency_inputDup_int4(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_int4__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_int4", conv2d_lowLatency_inputDup_int4);
