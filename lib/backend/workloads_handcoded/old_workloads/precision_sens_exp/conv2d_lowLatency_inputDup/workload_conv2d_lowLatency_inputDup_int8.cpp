...
int32_t conv2d_lowLatency_inputDup_int8(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_int8__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_int8", conv2d_lowLatency_inputDup_int8);
