...
int32_t vadd_int4(System* sys, std::string param_file){
    ...
    PrecisionT::Precision precision_output = PrecisionT::INT4;
...
static __attribute__((unused)) Registry::Entry &__vadd_int4__ = pimsim::registerFunc("vadd_int4", vadd_int4);