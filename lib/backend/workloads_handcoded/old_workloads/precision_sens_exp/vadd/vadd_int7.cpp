...
int32_t vadd_int7(System* sys, std::string param_file){
    std::vector<Request> requests;
    Request *request;

    //int array_size = 256*128*sys->_config->_ntiles_used;
    int array_size = 120*256*512;
    // PrecisionT::Precision precision_input = PrecisionT::INT7;
    // PrecisionT::Precision precision_output = PrecisionT::INT7;

    PrecisionT::Precision precision_input = PrecisionT::Precision{0, 7, 0};
    PrecisionT::Precision precision_output = PrecisionT::Precision{0, 7, 0};
...
static __attribute__((unused)) Registry::Entry &__vadd_int7__ = pimsim::registerFunc("vadd_int7", vadd_int7);