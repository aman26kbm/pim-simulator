...
int32_t vadd_int6(System* sys, std::string param_file){
    std::vector<Request> requests;
    Request *request;

    //int array_size = 256*128*sys->_config->_ntiles_used;
    int array_size = 120*256*512;
    // PrecisionT::Precision precision_input = PrecisionT::INT6;
    // PrecisionT::Precision precision_output = PrecisionT::INT6;

    PrecisionT::Precision precision_input = PrecisionT::Precision{0, 6, 0};
    PrecisionT::Precision precision_output = PrecisionT::Precision{0, 6, 0};
...
static __attribute__((unused)) Registry::Entry &__vadd_int6__ = pimsim::registerFunc("vadd_int6", vadd_int6);