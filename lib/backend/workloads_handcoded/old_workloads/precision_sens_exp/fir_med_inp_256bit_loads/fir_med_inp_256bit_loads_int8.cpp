...
int32_t fir_med_inp_256bit_loads_int8(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__fir_med_inp_256bit_loads_int8__ = pimsim::registerFunc("fir_med_inp_256bit_loads_int8", fir_med_inp_256bit_loads_int8);