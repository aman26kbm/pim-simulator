...
int32_t gemv_new_half(System* sys, std::string param)
{
...
static __attribute__((unused)) Registry::Entry &__gemv_new_half__ = pimsim::registerFunc("gemv_new_half", gemv_new_half);
