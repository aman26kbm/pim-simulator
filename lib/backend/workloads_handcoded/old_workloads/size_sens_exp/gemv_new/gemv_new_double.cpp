...
int32_t gemv_new_double(System* sys, std::string param)
{
    //int matrix_row = 32768*1;//32768 * X
    //int matrix_col = 4096 *1;// 4096 * Y
    int matrix_row = 120*512*2;
...
static __attribute__((unused)) Registry::Entry &__gemv_new_double__ = pimsim::registerFunc("gemv_new_double", gemv_new_double);
