...
int32_t fir_med_inp_256bit_loads_double(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__fir_med_inp_256bit_loads_double__ = pimsim::registerFunc("fir_med_inp_256bit_loads_double", fir_med_inp_256bit_loads_double);