...
int32_t conv2d_lowLatency_inputDup_half(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_half__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_half", conv2d_lowLatency_inputDup_half);
