...
int32_t conv2d_lowLatency_inputDup_double(System* sys, std::string param_file)
{
    ...
    //Parameters:
    conv_layer_params.N = 4;
    conv_layer_params.H = 32*2;
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_double__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_double", conv2d_lowLatency_inputDup_double);
