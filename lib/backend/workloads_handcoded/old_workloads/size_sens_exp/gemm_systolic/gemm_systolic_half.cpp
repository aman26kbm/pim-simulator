...
int32_t gemm_systolic_half(System* sys, std::string params){
...
static __attribute__((unused)) Registry::Entry &__gemm_systolic_half__ = pimsim::registerFunc("gemm_systolic_half", gemm_systolic_half);