...
int32_t vadd_double(System* sys, std::string param_file){
    std::vector<Request> requests;
    Request *request;

    //int array_size = 256*128*sys->_config->_ntiles_used;
    int array_size = 120*256*512*2;
...
static __attribute__((unused)) Registry::Entry &__vadd_double__ = pimsim::registerFunc("vadd_double", vadd_double);