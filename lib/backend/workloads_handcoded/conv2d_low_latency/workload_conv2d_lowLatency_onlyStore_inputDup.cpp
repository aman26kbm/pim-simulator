...
int32_t conv2d_lowLatency_onlyStore_inputDup(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_onlyStore_inputDup__ = pimsim::registerFunc("conv2d_lowLatency_onlyStore_inputDup", conv2d_lowLatency_onlyStore_inputDup);
