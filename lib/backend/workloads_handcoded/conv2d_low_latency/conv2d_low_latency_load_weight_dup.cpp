...
void conv2d_low_latency_load_weight_dup(Conv_layer_params conv_layer_params, \
    ...
    for(int phase=0; phase<1; phase++){
        sys->app_param_file<<"phase: "<<phase<<std::endl;
        for(int tile=0; tile<meshWidth; tile++){
            sys->app_param_file<<"tile: "<<tile<<std::endl;
            int data_volume = M * C * R * S/ meshWidth/1;
            ...
            sys->app_param_file<<"broadcast"<<std::endl;
            ...
            sys->app_param_file<<"data_volume: "<<data_volume<<std::endl;
