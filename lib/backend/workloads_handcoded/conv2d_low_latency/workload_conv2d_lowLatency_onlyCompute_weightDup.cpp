...
int32_t conv2d_lowLatency_onlyCompute_weightDup(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_onlyComput_weightDupe__ = pimsim::registerFunc("conv2d_lowLatency_onlyCompute_weightDup", conv2d_lowLatency_onlyCompute_weightDup);
