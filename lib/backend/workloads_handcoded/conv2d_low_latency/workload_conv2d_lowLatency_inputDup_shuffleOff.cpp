...
int32_t conv2d_lowLatency_inputDup_shuffleOff(System* sys, std::string param_file)
{
    ...
    //load input
    conv2d_low_latency_load_input_dup_shuffleOff(conv_layer_params, precision_input, precision_multiply, precision_accumulate, requests, sys);
    //start compute
    conv2d_low_latency_compute_input_dup_shuffleOff(conv_layer_params, precision_input, precision_multiply, precision_accumulate, requests, sys);
    //store output
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_inputDup_shuffleOff__ = pimsim::registerFunc("conv2d_lowLatency_inputDup_shuffleOff", conv2d_lowLatency_inputDup_shuffleOff);
