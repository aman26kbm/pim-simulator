...
int32_t conv2d_lowLatency_onlyLoadInput(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__conv2d_lowLatency_onlyLoadInput__ = pimsim::registerFunc("conv2d_lowLatency_onlyLoadInput", conv2d_lowLatency_onlyLoadInput);
