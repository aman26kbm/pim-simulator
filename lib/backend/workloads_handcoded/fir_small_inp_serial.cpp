...
int32_t fir_small_inp_serial(System* sys)
{
    ...
    //Each core will load 5 arrays worth of data
    //The last array's data will be wasted
    //The other 4 will compute easily

    int param = 4; //this is the last multiplier in the input_size
...
static __attribute__((unused)) Registry::Entry &__fir_small_inp_serial__ = pimsim::registerFunc("fir_small_inp_serial", fir_small_inp_serial);
