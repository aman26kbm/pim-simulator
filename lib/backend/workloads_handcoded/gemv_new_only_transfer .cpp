...
int32_t gemv_new_only_transfer(System* sys)
{
...
static __attribute__((unused)) Registry::Entry &__gemv_new_only_transfer__ = pimsim::registerFunc("gemv_new_only_transfer", gemv_new_only_transfer);