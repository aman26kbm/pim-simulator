...
int32_t gemv_new_no_transfer(System* sys)
{
...
static __attribute__((unused)) Registry::Entry &__gemv_new_no_transfer__ = pimsim::registerFunc("gemv_new_no_transfer", gemv_new_no_transfer);