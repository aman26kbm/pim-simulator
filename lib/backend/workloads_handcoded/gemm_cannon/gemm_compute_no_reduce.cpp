...
int32_t gemm_compute_no_reduce(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__gemm_compute_no_reduce__ = pimsim::registerFunc("gemm_compute_no_reduce", gemm_compute_no_reduce);
