...
int32_t gemm_store(System* sys, std::string param_file)
{
...
static __attribute__((unused)) Registry::Entry &__gemm_store__ = pimsim::registerFunc("gemm_store", gemm_store);
