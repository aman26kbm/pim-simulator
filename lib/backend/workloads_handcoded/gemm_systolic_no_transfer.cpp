...
int32_t gemm_systolic_no_transfer(System* sys){
...
static __attribute__((unused)) Registry::Entry &__gemm_systolic__ = pimsim::registerFunc("gemm_systolic_no_transfer", gemm_systolic_no_transfer);