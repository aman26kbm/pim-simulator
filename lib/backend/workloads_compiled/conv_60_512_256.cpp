...
int32_t conv_60_512_256(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 98; ++ax0_ax1_fused_ax2_fused) {
    // cram-array axis
    {
      ...
      for (int32_t ry = 0; ry < 3; ++ry) {
        for (int32_t rx = 0; rx < 3; ++rx) {
          ...
          if (_3) {
            int32_t _4 = ax0_ax1_fused_ax2_fused / 49;
            int32_t _5 = _4 * 20736;
            int32_t _6 = ax0_ax1_fused_ax2_fused % 49;
            int32_t _7 = _6 / 7;
            int32_t _8 = _7 * 2304;
            int32_t _9 = _5 + _8;
            int32_t _10 = ry * 2304;
            ...
            int32_t _12 = rx * 256;
            int32_t _13 = _11 + _12;
            int32_t _14 = ax0_ax1_fused_ax2_fused % 7;
            int32_t _15 = _14 * 256;
            int32_t _16 = _13 + _15;
            int32_t _17 = _16 + rc_outer;
            int32_t _18 = _17 % 128;
            bool _19 = _18 == 0;
            if (_19) {
              {
                Request request(Request::Type::RowLoad_RF);
                request.addOperand(ax0_ax1_fused_ax2_fused * 32, 512, PrecisionT::Precision{0, 8, 0} /*RegisterFile*/);
    ...
    void* _20 = (void*) "Conv2dOutput.repl.global[ramp(0, 1, 256)] = x256(0)/*skip-init*/";
