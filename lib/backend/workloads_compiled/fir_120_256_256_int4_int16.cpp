...
int32_t fir_120_256_256_int4_int16(System *sys) {
  void* _1 = nullptr;
      ...
      for (int32_t x_inner_outer_inner = 0; x_inner_outer_inner < 32; ++x_inner_outer_inner) {
        ...
        // cram-array axis
        {
          int32_t rv = 0;
          {
            ...
            request.addOperand(sys->getAddress(x_outer, 0, 16), 65536, PrecisionT::Precision{0, 8, 0} /**/);
            request.addOperand(sys->getAddress(x_outer, 0, 32), 65536, PrecisionT::Precision{0, 4, 0} /*a[ramp(((((x.outer*65536) + (x.inner.outer.outer*8192)) + (x.inner.outer.inner*256)) + rv), 1, 256)]*/);
            request.addOperand(sys->getAddress(x_outer, 0, 0), 32, PrecisionT::Precision{0, 4, 0} /*b[rv]*/);
...
static __attribute__((unused)) Registry::Entry &_fir_120_256_256_int4_int16__ = pimsim::registerFunc("fir_120_256_256_int4_int16", fir_120_256_256_int4_int16);
