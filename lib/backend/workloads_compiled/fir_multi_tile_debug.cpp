...
int32_t fir_multi_tile_compiled_debug(System *sys) {
  void* _1 = nullptr;
  ...
  // cram-tile axis
  int32_t x_outer = 0;
  for (int32_t x_outer = 0; x_outer < 96; ++x_outer) {
    // cram-array axis
    {
...
static __attribute__((unused)) Registry::Entry &__fir_multi_tile_compiled_debug__ = pimsim::registerFunc("fir_multi_tile_compiled_debug", fir_multi_tile_compiled_debug);
