...
int32_t gemm_240_128_256(System *sys) {
  void* _1 = nullptr;
      ...
      // cram-array axis
      {
        ...
        for (int32_t rv_inner = 0; rv_inner < 16; ++rv_inner) {
          ...
          }
          {
            ...
            request.addOperand(xo_outer * 32, 0, PrecisionT::Precision{0, 8, 0} /*b[(((y.inner*2048) + (rv.outer*16)) + rv.inner)]*/);
            sys->sendRequest(request);
          }
          {
...
static __attribute__((unused)) Registry::Entry &_gemm_240_128_256__ = pimsim::registerFunc("gemm_240_128_256", gemm_240_128_256);
