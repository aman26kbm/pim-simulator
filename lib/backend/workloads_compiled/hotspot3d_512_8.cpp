    ...
    // cram-array axis
    {
      ...
      // cram-array axis
      {
        ...
        }
        {
          ...
          request.addOperand(sys->getAddress(x_outer, 0, 153), 0, PrecisionT::Precision{1, 23, 8} /**/);
        ...
        {
          Request request(Request::Type::RowMul_CRAM_RF);
          request.addOperand(sys->getAddress(x_outer, 0, 178), 0, PrecisionT::Precision{1, 23, 8} /**/);
        ...
        }
        {
          ...
          request.addOperand(sys->getAddress(x_outer, 0, 190), 0, PrecisionT::Precision{1, 23, 8} /**/);
          request.addOperand(sys->getAddress(x_outer, 0, 178), 0, PrecisionT::Precision{1, 23, 8} /**/);
        ...
        }
        {
          ...
          request.addOperand(sys->getAddress(x_outer, 0, 0), 0, PrecisionT::Precision{1, 23, 8} /*DRAM*/);
          request.addOperand(sys->getAddress(x_outer, 0, 190), 0, PrecisionT::Precision{1, 23, 8} /*CRAM*/);
          sys->sendRequest(request);
        }
      }
    }
