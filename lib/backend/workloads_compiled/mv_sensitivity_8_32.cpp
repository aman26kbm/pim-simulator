...
int32_t mv_sensitivity_compiled_8_32(System *sys) {
  void* _1 = nullptr;
...
static __attribute__((unused)) Registry::Entry &__mv_sensitivity_compiled_8_32__ = pimsim::registerFunc("mv_sensitivity_compiled_8_32", mv_sensitivity_compiled_8_32);
