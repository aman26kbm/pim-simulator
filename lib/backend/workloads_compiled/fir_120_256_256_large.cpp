...
int32_t fir_120_256_256_large(System *sys) {
  void* _1 = nullptr;
      ...
      for (int32_t x_inner_outer_inner = 0; x_inner_outer_inner < 64; ++x_inner_outer_inner) {
        ...
        // cram-array axis
        {
          int32_t rv = 0;
          {
            ...
            request.addOperand(sys->getAddress(x_outer, 0, 32), 65536, PrecisionT::Precision{0, 16, 0} /*a[ramp(((((x.outer*131072) + (x.inner.outer.outer*16384)) + (x.inner.outer.inner*256)) + rv), 1, 256)]*/);
...
static __attribute__((unused)) Registry::Entry &_fir_120_256_256_large__ = pimsim::registerFunc("fir_120_256_256_large", fir_120_256_256_large);
