...
int32_t fir_120_256_256_240(System *sys) {
  void* _1 = nullptr;
        ...
        for (int32_t rv = 0; rv < 32; ++rv) {
          {
            ...
            request.addOperand(sys->getAddress(x_outer, 0, 16), 65536, PrecisionT::Precision{0, 16, 0} /*a[ramp(((((x.outer*131072) + (x.inner.outer.outer*512)) + (x.inner.outer.inner*256)) + rv), 1, 256)]*/);
...
static __attribute__((unused)) Registry::Entry &_fir_120_256_256_240__ = pimsim::registerFunc("fir_120_256_256_240", fir_120_256_256_240);
