...
int32_t conv_120_256_256_int16_int32(System *sys) {
  void* _1 = nullptr;
      ...
      for (int32_t ry = 0; ry < 3; ++ry) {
        for (int32_t rx = 0; rx < 3; ++rx) {
          ...
          }
          {
            ...
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 80), 65536, PrecisionT::Precision{0, 16, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 0), 256, PrecisionT::Precision{0, 8, 0} /*x[(((((((ax0.ax1.fused.ax2.fused/49)*20736) + (((ax0.ax1.fused.ax2.fused % 49)/7)*2304)) + (ry*2304)) + (rx*256)) + ((ax0.ax1.fused.ax2.fused % 7)*256)) + rc.outer)]*/);
          ...
          }
          {
            ...
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 80), 65536, PrecisionT::Precision{0, 32, 0} /**/);
...
static __attribute__((unused)) Registry::Entry &_conv_120_256_256_int16_int32__ = pimsim::registerFunc("conv_120_256_256_int16_int32", conv_120_256_256_int16_int32);
