...
int32_t mv_sensitivity_compiled_32_16(System *sys) {
  void* _1 = nullptr;
...
static __attribute__((unused)) Registry::Entry &__mv_sensitivity_compiled_32_16__ = pimsim::registerFunc("mv_sensitivity_compiled_32_16", mv_sensitivity_compiled_32_16);
