...
int32_t mv_16_256_256_int8_int32(System *sys) {
  void* _1 = nullptr;
  ...
  for (int32_t x_outer_outer = 0; x_outer_outer < 16; ++x_outer_outer) {
    for (int32_t x_outer_inner = 0; x_outer_inner < 15; ++x_outer_inner) {
      // cram-array axis
      {
        int32_t k_outer = 0;
...
static __attribute__((unused)) Registry::Entry &_mv_16_256_256_int8_int32__ = pimsim::registerFunc("mv_16_256_256_int8_int32", mv_16_256_256_int8_int32);
