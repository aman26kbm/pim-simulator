...
int32_t vgg4(System *sys) {
  void* _1 = nullptr;
  uint64_t _2 = (uint64_t)1605632;
              ...
              if (_15) {
                {
                  ...
                  request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_outer_outer, 0, 128), 0, PrecisionT::Precision{1, 23, 8} /*placeholder[ramp((((ry*393216) + (rx*131072)) + (rc.outer*512)), 1, 512)]*/);
  ...
  for (int32_t ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 45; ++ax0_ax1_fused_ax2_fused_outer) {
    for (int32_t ax0_ax1_fused_ax2_fused_inner1 = 0; ax0_ax1_fused_ax2_fused_inner1 < 5; ++ax0_ax1_fused_ax2_fused_inner1) {
      ...
      for (int32_t rv0 = 0; rv0 < 2; ++rv0) {
        for (int32_t rv1 = 0; rv1 < 2; ++rv1) {
            ...
            for (int32_t ry1 = 0; ry1 < 3; ++ry1) {
              for (int32_t rx1 = 0; rx1 < 3; ++rx1) {
                for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
                  int32_t _32 = ax0_ax1_fused_ax2_fused_outer * 5;
          ...
          #undef max
            int32_t _36 = ax0_ax1_fused_ax2_fused_outer * 5;
          ...
          int32_t _39 = ax0_ax1_fused_ax2_fused_outer * 5;
      ...
      int32_t _42 = ax0_ax1_fused_ax2_fused_outer * 5;
...
static __attribute__((unused)) Registry::Entry &_vgg4__ = pimsim::registerFunc("vgg4", vgg4);
