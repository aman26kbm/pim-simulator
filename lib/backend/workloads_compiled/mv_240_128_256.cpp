...
int32_t mv_240_128_256(System *sys) {
  void* _1 = nullptr;
    ...
    // cram-array axis
    {
      ...
      for (int32_t k_inner = 0; k_inner < 32; ++k_inner) {
        ...
        }
        {
          ...
          request.addOperand(x_outer_outer * 32, 0, PrecisionT::Precision{0, 8, 0} /*b[((k.outer*32) + k.inner)]*/);
          sys->sendRequest(request);
        }
        {
...
static __attribute__((unused)) Registry::Entry &_mv_240_128_256__ = pimsim::registerFunc("mv_240_128_256", mv_240_128_256);
