...
int32_t mv_sensitivity_compiled_4_64(System *sys) {
  void* _1 = nullptr;
...
static __attribute__((unused)) Registry::Entry &__mv_sensitivity_compiled_4_64__ = pimsim::registerFunc("mv_sensitivity_compiled_4_64", mv_sensitivity_compiled_4_64);
