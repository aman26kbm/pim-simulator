...
int32_t backprop_65536_16(System *sys,std::string param_file) {
  void* _1 = nullptr;
  ...
  for (int32_t ax0 = 0; ax0 < 16; ++ax0) {
    // cram-array axis
    {
      int32_t rv_outer = 0;
      {
        ...
        request.addOperand(sys->getAddress(ax0, 0, 32), 0, PrecisionT::Precision{1, 23, 8} /*placeholder[ramp((rv.outer*256), 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowLoad);
        request.addOperand(sys->getAddress(ax0, 0, 0), 0, PrecisionT::Precision{1, 23, 8} /*DRAM*/);
        request.addOperand(sys->getAddress(ax0, 0, 64), 0, PrecisionT::Precision{1, 23, 8} /*placeholder[ramp(((ax0*65536) + (rv.outer*256)), 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowMul);
        request.addOperand(sys->getAddress(ax0, 0, 0), 0, PrecisionT::Precision{1, 23, 8} /**/);
        request.addOperand(sys->getAddress(ax0, 0, 32), 0, PrecisionT::Precision{1, 23, 8} /*placeholder[ramp((rv.outer*256), 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0, 0, 64), 0, PrecisionT::Precision{1, 23, 8} /*placeholder[ramp(((ax0*65536) + (rv.outer*256)), 1, 256)]*/);
        sys->sendRequest(request);
      }
...
static __attribute__((unused)) Registry::Entry &_backprop_65536_16__ = pimsim::registerFunc("backprop_65536_16", backprop_65536_16);