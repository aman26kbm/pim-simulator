...
int32_t hotspot_1024_1024(System *sys,std::string param_file) {
  void* _1 = nullptr;
  ...
  for (int32_t x_outer = 0; x_outer < 16; ++x_outer) {
    // cram-array axis
    {
      ...
      // cram-array axis
      {
        ...
        {
          Request request(Request::Type::RowMul_CRAM_RF);
          request.addOperand(sys->getAddress(x_outer, 0, 152), 0, PrecisionT::Precision{1, 23, 8} /**/);
          request.addOperand(sys->getAddress(x_outer, 0, 136), 0, PrecisionT::Precision{1, 23, 8} /**/);
          request.addOperand(x_outer * 32, 0, PrecisionT::Precision{1, 23, 8} /*ConstFloat*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowLoad);
          request.addOperand(sys->getAddress(x_outer, 0, 0), 0, PrecisionT::Precision{1, 23, 8} /*DRAM*/);
          request.addOperand(sys->getAddress(x_outer, 0, 104), 0, PrecisionT::Precision{1, 23, 8} /*power[ramp((((x.outer*65536) + (x.inner*1024)) + (y.outer*256)), 1, 256)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
        ...
        }
        {
          ...
          request.addOperand(sys->getAddress(x_outer, 0, 120), 0, PrecisionT::Precision{1, 23, 8} /**/);
          request.addOperand(sys->getAddress(x_outer, 0, 0), 0, PrecisionT::Precision{1, 23, 8} /*in.global[ramp(259, 1, 256)]*/);
...
static __attribute__((unused)) Registry::Entry &_hotspot_1024_1024__ = pimsim::registerFunc("hotspot_1024_1024", hotspot_1024_1024);
