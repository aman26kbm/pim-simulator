...
int32_t mv_sensitivity_compiled_64_4(System *sys) {
  void* _1 = nullptr;
  // int32_t c_global_rf[1024], 0
  // int8_t a_global[256], 1024
  // int32_t c_global[1024], 1280
  // cram-tile axis
  for (int32_t x_outer_outer = 0; x_outer_outer < 64; ++x_outer_outer) {
...
static __attribute__((unused)) Registry::Entry &__mv_sensitivity_compiled_64_4__ = pimsim::registerFunc("mv_sensitivity_compiled_64_4", mv_sensitivity_compiled_64_4);
