...
int32_t vgg_bnn_13_4(System *sys) {
  void* _1 = nullptr;
        ...
        for (int32_t rx = 0; rx < 3; ++rx) {
          {
            ...
            request.addOperand(sys->getAddress(0, 0, 0), 0, PrecisionT::Precision{0, 1, 0} /*kernel[ramp(((((ry*393216) + (rx*131072)) + (rc.outer*512)) + (ff.outer*256)), 1, 256)]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowMul);
            request.addOperand(sys->getAddress(0, 0, 8), 0, PrecisionT::Precision{0, 2, 0} /**/);
            request.addOperand(sys->getAddress(0, 0, 0), 0, PrecisionT::Precision{0, 1, 0} /*image[(((ry*768) + (rx*256)) + rc.outer)]*/);
            request.addOperand(sys->getAddress(0, 0, 0), 0, PrecisionT::Precision{0, 1, 0} /*kernel[ramp(((((ry*393216) + (rx*131072)) + (rc.outer*512)) + (ff.outer*256)), 1, 256)]*/);
            sys->sendRequest(request);
          }
          {
            ...
            request.addOperand(sys->getAddress(0, 0, 8), 0, PrecisionT::Precision{0, 8, 0} /**/);
            request.addOperand(sys->getAddress(0, 0, 8), 0, PrecisionT::Precision{0, 8, 0} /*Conv2dOutput.rf[ramp(((rc.outer*512) + (ff.outer*256)), 1, 256)]*/);
            sys->sendRequest(request);
          }
        }
      }
    ...
    #undef max
      {
        ...
        request.addOperand(sys->getAddress(0, 0, 8), 0, PrecisionT::Precision{0, 8, 0} /*Conv2dOutput[ramp((ax3.outer*256), 1, 256)]*/);
...
static __attribute__((unused)) Registry::Entry &_vgg_bnn_13_4__ = pimsim::registerFunc("vgg_bnn_13_4", vgg_bnn_13_4);
