  ...
  for (int32_t ax0_ax1_fused_ax2_outer_outer_fused = 0; ax0_ax1_fused_ax2_outer_outer_fused < 28; ++ax0_ax1_fused_ax2_outer_outer_fused) {
    // cram-array axis
    {
            ...
            for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((((ry*98304) + (rx*32768)) + (rc.outer*1024)) + (rc.inner*256)), 1, 256)]*/);
                request.addOperand(ax0_ax1_fused_ax2_outer_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7424) + (ry*3712)) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256)) + (rx*128)) + (rc.outer*4)) + rc.inner)]*/);
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 0, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 32, 0} /*placeholder[ramp(0, 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 128), 0, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 144), 0, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
...
int32_t tvmgen_default_fused_nn_conv2d_add_cast_multiply_add_right_shift_cast_cast_fixed_point_multiply_2938127200454701776_(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_outer_outer_fused = 0; ax0_ax1_fused_ax2_outer_outer_fused < 112; ++ax0_ax1_fused_ax2_outer_outer_fused) {
    // cram-array axis
    {
        ...
        for (int32_t ry = 0; ry < 3; ++ry) {
          for (int32_t rx = 0; rx < 3; ++rx) {
            for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
              {
                Request request(Request::Type::RowMul);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 0, PrecisionT::Precision{0, 16, 0} /**/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[((((x256(((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*3712) + (ry*3712)) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256))) + ((let rmod = (ramp(0, 1, 256) % x256(64)) in (let rdiv = (ramp(0, 1, 256)/x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rdiv, (rdiv - x256(1)))))*x256(64))) + x256((rx*64))) + x256((rc.outer*2))) + x256(rc.inner))]*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*12288) + (rx*4096)) + (rc.outer*128)) + (rc.inner*64))) + (let rmod = (ramp(0, 1, 256) % x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(64)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
      ...
      {
        Request request(Request::Type::RowMul_CRAM_RF);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 72), 0, PrecisionT::Precision{0, 40, 0} /**/);
        ...
        for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
          {
            Request request(Request::Type::RowMul_CRAM_RF);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((rc.outer*1024) + (rc.inner*256)), 1, 256)]*/);
            request.addOperand(ax0_ax1_fused_ax2_outer_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7168) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256)) + (rc.outer*4)) + rc.inner)]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowAdd);
      ...
      for (int32_t rv0 = 0; rv0 < 3; ++rv0) {
        for (int32_t rv1 = 0; rv1 < 3; ++rv1) {
          ...
          // }
          {
            ...
            request.addOperand(sys->getAddress(ax1, 0, 0), 0, PrecisionT::Precision{0, 8, 0} /*tensor[ramp(((ax1*3584) + (ax2*64)), 1, 64)]*/);
            request.addOperand(sys->getAddress(ax1, 0, 4), 0, PrecisionT::Precision{0, 8, 0} /*ConstInt*/);
            sys->sendRequest(request);
          }
          // {
          //   Request request(Request::Type::RowStore);
      ...
      for (int32_t ry = 0; ry < 7; ++ry) {
        for (int32_t rx = 0; rx < 7; ++rx) {
          for (int32_t rc = 0; rc < 3; ++rc) {
            {
              Request request(Request::Type::RowMul_CRAM_RF);
              request.addOperand(sys->getAddress(ax1, 0, 12), 0, PrecisionT::Precision{0, 16, 0} /**/);
              request.addOperand(sys->getAddress(ax1, 0, 8), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((ry*1344) + (rx*192)) + (rc*64)), 1, 64)]*/);
              request.addOperand(ax1 * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((ax1*1374) + (ry*687)) + (ax2*6)) + (rx*3)) + rc)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
            ...
            for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*49152) + (rx*16384)) + (rc.outer*512)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
...
int32_t tvmgen_default_fused_nn_conv2d_add_cast_multiply_add_right_shift_cast_cast_fixed_point_multiply_2938127200454701776__2(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_outer_fused = 0; ax0_ax1_fused_ax2_outer_fused < 98; ++ax0_ax1_fused_ax2_outer_fused) {
    for (int32_t ax2_inner = 0; ax2_inner < 2; ++ax2_inner) {
      // cram-array axis
      {
        ...
        for (int32_t ry = 0; ry < 3; ++ry) {
          for (int32_t rx = 0; rx < 3; ++rx) {
            {
              Request request(Request::Type::RowMul_CRAM_RF);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((ry*196608) + (rx*65536)) + (rc.outer*256)), 1, 256)]*/);
              request.addOperand(ax0_ax1_fused_ax2_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((ax0.ax1.fused.ax2.outer.fused/7)*4096) + (ry*4096)) + ((ax0.ax1.fused.ax2.outer.fused % 7)*512)) + (ax2.inner*256)) + (rx*256)) + rc.outer)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
      ...
      {
        Request request(Request::Type::RowMul_CRAM_RF);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 72), 0, PrecisionT::Precision{0, 40, 0} /**/);
...
int32_t tvmgen_default_fused_nn_conv2d_add_cast_multiply_add_right_shift_cast_add_clip_cast_2(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused_ax3_outer_fused = 0; ax0_ax1_fused_ax2_fused_ax3_outer_fused < 98; ++ax0_ax1_fused_ax2_fused_ax3_outer_fused) {
    // cram-array axis
    {
      ...
      {
        Request request(Request::Type::RowMul_CRAM_RF);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((rc.outer*512) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
        request.addOperand(ax0_ax1_fused_ax2_fused_ax3_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*placeholder[((((ax0.ax1.fused.ax2.fused.ax3.outer.fused/14)*7168) + (tir.shift_right((ax0.ax1.fused.ax2.fused.ax3.outer.fused % 14), 1)*512)) + rc.outer)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        ...
        for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
          {
            Request request(Request::Type::RowMul);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 0, PrecisionT::Precision{0, 16, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(((x256((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7168) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256))) + ((let rmod = (ramp(0, 1, 256) % x256(128)) in (let rdiv = (ramp(0, 1, 256)/x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rdiv, (rdiv - x256(1)))))*x256(128))) + x256((rc.outer*2))) + x256(rc.inner))]*/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((rc.outer*256) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowAdd);
...
int32_t tvmgen_default_fused_nn_conv2d_add_cast_multiply_add_right_shift_cast_cast_fixed_point_multiply_2938127200454701776__3(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused_ax3_outer_fused = 0; ax0_ax1_fused_ax2_fused_ax3_outer_fused < 98; ++ax0_ax1_fused_ax2_fused_ax3_outer_fused) {
          ...
          for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
            {
              Request request(Request::Type::RowMul_CRAM_RF);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((((ry*786432) + (rx*262144)) + (rc.outer*1024)) + (rc.inner*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
              request.addOperand(ax0_ax1_fused_ax2_fused_ax3_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((ax0.ax1.fused.ax2.fused.ax3.outer.fused/14)*4608) + (ry*4608)) + (tir.shift_right((ax0.ax1.fused.ax2.fused.ax3.outer.fused % 14), 1)*512)) + (rx*512)) + (rc.outer*2)) + rc.inner)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
    ...
    {
      Request request(Request::Type::RowMul_CRAM_RF);
      request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 72), 0, PrecisionT::Precision{0, 40, 0} /**/);
            ...
            for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*24576) + (rx*8192)) + (rc.outer*256)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
        ...
        for (int32_t rx = 0; rx < 3; ++rx) {
          {
            Request request(Request::Type::RowMul_CRAM_RF);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((((ry*393216) + (rx*131072)) + (rc.outer*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
            request.addOperand(ax0_ax1_fused_ax2_fused_ax3_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[((((((ax0.ax1.fused.ax2.fused.ax3.outer.fused/14)*7680) + (ry*3840)) + (tir.shift_right((ax0.ax1.fused.ax2.fused.ax3.outer.fused % 14), 1)*512)) + (rx*256)) + rc.outer)]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowAdd);
