...
int32_t tvmgen_default_fused_nn_conv2d_add_cast_multiply_add_right_shift_cast_clip_cast_cast_1(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_outer_outer_fused = 0; ax0_ax1_fused_ax2_outer_outer_fused < 56; ++ax0_ax1_fused_ax2_outer_outer_fused) {
    // cram-array axis
    {
            ...
            for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 57344, PrecisionT::Precision{0, 16, 0} /**/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 57344, PrecisionT::Precision{0, 8, 0} /*PaddedInput[((((x256(((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7296) + (ry*3648)) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256))) + ((let rmod = (ramp(0, 1, 256) % x256(128)) in (let rdiv = (ramp(0, 1, 256)/x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rdiv, (rdiv - x256(1)))))*x256(128))) + x256((rx*64))) + x256((rc.outer*2))) + x256(rc.inner))]*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*24576) + (rx*8192)) + (rc.outer*256)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 57344, PrecisionT::Precision{0, 32, 0} /**/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 57344, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer*256), 1, 256)]*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 57344, PrecisionT::Precision{0, 32, 0} /**/);
                sys->sendRequest(request);
              }
            }
          }
      ...
      #undef max
        {
          ...
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 57344, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 57344, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 57344, PrecisionT::Precision{0, 32, 0} /**/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 57344, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 57344, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
          sys->sendRequest(request);
        }
      ...
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 1792, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 1792, PrecisionT::Precision{0, 32, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowMul);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 192), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 128), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 144), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 192), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 128), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 144), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd_CRAM_RF);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 1792, PrecisionT::Precision{0, 32, 0} /**/);
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 112; ++ax1_outer) {
    // cram-array axis
    {
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax1_outer, 0, 0), 1344, PrecisionT::Precision{1, 23, 8} /**/);
        request.addOperand(sys->getAddress(ax1_outer, 0, 0), 1344, PrecisionT::Precision{1, 23, 8} /*placeholder[(((((let rmod = (ramp(0, 1, 168) % x168(3)) in select(((x168((bool)1) && (x168(0) <= rmod)) || (x168((bool)0) && (rmod <= x168(0)))), rmod, (rmod + x168(3))))*x168(50176)) + x168((ax1.outer*448))) + x168((ax1.inner.ax2.outer.fused*56))) + (let rmod = (ramp(0, 1, 168) % x168(3)) in (let rdiv = (ramp(0, 1, 168)/x168(3)) in select(((x168((bool)1) && (x168(0) <= rmod)) || (x168((bool)0) && (rmod <= x168(0)))), rdiv, (rdiv - x168(1))))))]*/);
      ...
      {
        Request request(Request::Type::RowMul);
        request.addOperand(sys->getAddress(ax1_outer, 0, 42), 1344, PrecisionT::Precision{1, 23, 8} /**/);
        request.addOperand(sys->getAddress(ax1_outer, 0, 0), 1344, PrecisionT::Precision{1, 23, 8} /**/);
        request.addOperand(sys->getAddress(ax1_outer, 0, 0), 1344, PrecisionT::Precision{1, 23, 8} /**/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd_CRAM_RF);
        request.addOperand(sys->getAddress(ax1_outer, 0, 21), 1344, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax1_outer, 0, 42), 1344, PrecisionT::Precision{1, 23, 8} /**/);
      ...
      {
        Request request(Request::Type::RowAdd_CRAM_RF);
        request.addOperand(sys->getAddress(ax1_outer, 0, 10), 1344, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax1_outer, 0, 21), 1344, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax1_outer, 0, -1), 8, PrecisionT::Precision{0, 32, 0} /*ConstInt*/);
        sys->sendRequest(request);
      }
      {
        ...
        request.addOperand(sys->getAddress(ax1_outer, 0, 0), 1344, PrecisionT::Precision{0, 16, 0} /*DRAM*/);
        request.addOperand(sys->getAddress(ax1_outer, 0, 10), 1344, PrecisionT::Precision{0, 8, 0} /*CRAM*/);
        sys->sendRequest(request);
      }
    }
  }
  ...
  for (int32_t ax0_ax1_fused_ax2_outer_outer_fused = 0; ax0_ax1_fused_ax2_outer_outer_fused < 112; ++ax0_ax1_fused_ax2_outer_outer_fused) {
    // cram-array axis
    {
            ...
            for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*12288) + (rx*4096)) + (rc.outer*128)) + (rc.inner*64))) + (let rmod = (ramp(0, 1, 256) % x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(64)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 1792, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 1792, PrecisionT::Precision{0, 32, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(64))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowMul);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 192), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 128), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(64))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 144), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[(let rmod = (ramp(0, 1, 256) % x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(64))))]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowMul_CRAM_RF);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 72), 1792, PrecisionT::Precision{0, 40, 0} /**/);
      ...
      {
        Request request(Request::Type::RowAdd_CRAM_RF);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, -1), 7, PrecisionT::Precision{0, 32, 0} /*ConstInt*/);
      ...
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 72), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        sys->sendRequest(request);
      }
      {
    ...
    // cram-array axis
    {
      ...
      for (int32_t rv0 = 0; rv0 < 3; ++rv0) {
        for (int32_t rv1 = 0; rv1 < 3; ++rv1) {
          ...
          {
            Request request(Request::Type::RowAdd_CRAM_RF);
            request.addOperand(sys->getAddress(ax1, 0, 4), 3584, PrecisionT::Precision{0, 8, 0} /**/);
            request.addOperand(sys->getAddress(ax1, 0, 0), 3584, PrecisionT::Precision{0, 8, 0} /*tensor[ramp(((ax1*3584) + (ax2*64)), 1, 64)]*/);
          ...
          }
          {
            Request request(Request::Type::RowStore);
            request.addOperand(sys->getAddress(ax1, 0, 0), 3584, PrecisionT::Precision{0, 8, 0} /*DRAM*/);
            request.addOperand(sys->getAddress(ax1, 0, 4), 3584, PrecisionT::Precision{0, 8, 0} /*CRAM*/);
            sys->sendRequest(request);
          }
        }
      }
...
int32_t tvmgen_default_fused_nn_conv2d_add_cast_multiply_add_right_shift_cast_2(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused_ax3_outer_fused = 0; ax0_ax1_fused_ax2_fused_ax3_outer_fused < 98; ++ax0_ax1_fused_ax2_fused_ax3_outer_fused) {
      ...
      for (int32_t ry = 0; ry < 3; ++ry) {
        for (int32_t rx = 0; rx < 3; ++rx) {
          for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
            {
              Request request(Request::Type::RowMul);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 65536, PrecisionT::Precision{0, 16, 0} /**/);
            ...
            {
              Request request(Request::Type::RowAdd);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 0), 65536, PrecisionT::Precision{0, 32, 0} /**/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 65536, PrecisionT::Precision{0, 32, 0} /**/);
    ...
    #undef max
      {
        Request request(Request::Type::BlockSend_Receive);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 32), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 0), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 32), 65536, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 32), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 0), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
        sys->sendRequest(request);
      }
        ...
        for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
          {
            Request request(Request::Type::RowMul);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 57344, PrecisionT::Precision{0, 16, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[(((x256((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7168) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256))) + ((let rmod = (ramp(0, 1, 256) % x256(128)) in (let rdiv = (ramp(0, 1, 256)/x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rdiv, (rdiv - x256(1)))))*x256(128))) + x256((rc.outer*2))) + x256(rc.inner))]*/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((rc.outer*256) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowAdd);
    ...
    // cram-array axis
    {
      ...
      // cram-array axis
      {
        ...
        for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
          {
            Request request(Request::Type::RowMul);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 16, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 224, PrecisionT::Precision{0, 8, 0} /*placeholder[(((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7168) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256)) + (rc.outer*4)) + rc.inner)]*/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((rc.outer*1024) + (rc.inner*256)), 1, 256)]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowAdd);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 57344, PrecisionT::Precision{0, 32, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 32, 0} /**/);
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 57344, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer*256), 1, 256)]*/);
            sys->sendRequest(request);
          }
        }
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 32), 1792, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 1792, PrecisionT::Precision{0, 32, 0} /*placeholder[ramp(0, 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowMul);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 192), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 128), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 144), 1792, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 1792, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
  ...
  for (int32_t ax0_ax1_fused_ax2_outer_fused = 0; ax0_ax1_fused_ax2_outer_fused < 98; ++ax0_ax1_fused_ax2_outer_fused) {
    for (int32_t ax2_inner = 0; ax2_inner < 2; ++ax2_inner) {
      // cram-array axis
      {
        ...
        for (int32_t ry = 0; ry < 3; ++ry) {
          for (int32_t rx = 0; rx < 3; ++rx) {
            {
              Request request(Request::Type::RowMul);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 80), 65536, PrecisionT::Precision{0, 16, 0} /**/);
            ...
            {
              Request request(Request::Type::RowAdd);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 0), 65536, PrecisionT::Precision{0, 32, 0} /**/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 80), 65536, PrecisionT::Precision{0, 32, 0} /**/);
      ...
      #undef max
        {
          Request request(Request::Type::BlockSend_Receive);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 32), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 0), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 32), 65536, PrecisionT::Precision{0, 32, 0} /**/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 32), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 256)]*/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 0), 65536, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
          sys->sendRequest(request);
        }
            ...
            for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
              {
                Request request(Request::Type::RowMul);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 16, 0} /**/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 224, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*7424) + (ry*3712)) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256)) + (rx*128)) + (rc.outer*4)) + rc.inner)]*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((((ry*98304) + (rx*32768)) + (rc.outer*1024)) + (rc.inner*256)), 1, 256)]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
            ...
            for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 57344, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*49152) + (rx*16384)) + (rc.outer*512)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
  ...
  for (int32_t ax0_ax1_outer_fused = 0; ax0_ax1_outer_fused < 4; ++ax0_ax1_outer_fused) {
    // cram-array axis
    {
      ...
      for (int32_t k_inner = 0; k_inner < 4; ++k_inner) {
        ...
        {
          Request request(Request::Type::RowMul);
          request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 78), 32000, PrecisionT::Precision{0, 32, 0} /**/);
          request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 0), 128, PrecisionT::Precision{0, 16, 0} /*placeholder[((k.outer*4) + k.inner)]*/);
          request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 62), 32000, PrecisionT::Precision{0, 16, 0} /*placeholder[ramp((((ax0.ax1.outer.fused*128000) + (k.outer*1000)) + (k.inner*250)), 1, 250)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
          request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 0), 32000, PrecisionT::Precision{0, 32, 0} /**/);
          request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 78), 32000, PrecisionT::Precision{0, 32, 0} /**/);
    ...
    #undef max
      {
        Request request(Request::Type::BlockSend_Receive);
        request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 31), 32000, PrecisionT::Precision{0, 32, 0} /*compute[ramp(0, 1, 250)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 0), 32000, PrecisionT::Precision{0, 32, 0} /*compute.rf[ramp((k.outer.v*250), 1, 250)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 31), 32000, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 31), 32000, PrecisionT::Precision{0, 32, 0} /*compute[ramp(0, 1, 250)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_outer_fused, 0, 0), 32000, PrecisionT::Precision{0, 32, 0} /*compute.rf[ramp((k.outer.v*250), 1, 250)]*/);
        sys->sendRequest(request);
      }
  ...
  for (int32_t ax1 = 0; ax1 < 112; ++ax1) {
    // cram-array axis
    {
      ...
      for (int32_t ry = 0; ry < 7; ++ry) {
        for (int32_t rx = 0; rx < 7; ++rx) {
          for (int32_t rc = 0; rc < 3; ++rc) {
            {
              Request request(Request::Type::RowMul);
              request.addOperand(sys->getAddress(ax1, 0, 12), 7168, PrecisionT::Precision{0, 16, 0} /**/);
              request.addOperand(sys->getAddress(ax1, 0, 0), 112, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((ax1*1374) + (ry*687)) + (ax2*6)) + (rx*3)) + rc)]*/);
              request.addOperand(sys->getAddress(ax1, 0, 8), 7168, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((ry*1344) + (rx*192)) + (rc*64)), 1, 64)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
      ...
      }
      {
        ...
        request.addOperand(sys->getAddress(ax1, 0, 12), 7168, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 0), 7168, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput[ramp(0, 1, 64)]*/);
        request.addOperand(sys->getAddress(ax1, 0, 8), 7168, PrecisionT::Precision{0, 32, 0} /*placeholder[ramp(0, 1, 64)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowMul);
        request.addOperand(sys->getAddress(ax1, 0, 40), 7168, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 12), 7168, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 24), 7168, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 64)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax1, 0, 28), 7168, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 40), 7168, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 24), 7168, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 64)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax1, 0, 16), 7168, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 28), 7168, PrecisionT::Precision{0, 64, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 12), 7168, PrecisionT::Precision{0, 64, 0} /*placeholder[ramp(0, 1, 64)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd_CRAM_RF);
        request.addOperand(sys->getAddress(ax1, 0, 12), 7168, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax1, 0, 16), 7168, PrecisionT::Precision{0, 32, 0} /**/);
