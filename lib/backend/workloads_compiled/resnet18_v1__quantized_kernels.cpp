            ...
            for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*12288) + (rx*4096)) + (rc.outer*256)) + (rc.inner*64))) + (let rmod = (ramp(0, 1, 256) % x256(64)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(64)))))]*/);
          ...
          for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
            {
              ...
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((((ry*786432) + (rx*262144)) + (rc.outer*2048)) + (rc.inner*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowMul_CRAM_RF);
              ...
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((((ry*786432) + (rx*262144)) + (rc.outer*2048)) + (rc.inner*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
              request.addOperand(ax0_ax1_fused_ax2_fused_ax3_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((ax0.ax1.fused.ax2.fused.ax3.outer.fused/14)*4608) + (ry*4608)) + (tir.shift_right((ax0.ax1.fused.ax2.fused.ax3.outer.fused % 14), 1)*512)) + (rx*512)) + (rc.outer*4)) + rc.inner)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
            ...
            for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
              {
                Request request(Request::Type::RowLoad);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 0, PrecisionT::Precision{0, 8, 0} /*DRAM*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*24576) + (rx*8192)) + (rc.outer*512)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowMul);
            ...
            for (int32_t rc_inner = 0; rc_inner < 8; ++rc_inner) {
              {
                Request request(Request::Type::RowLoad);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 0), 0, PrecisionT::Precision{0, 8, 0} /*DRAM*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*49152) + (rx*16384)) + (rc.outer*1024)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowMul);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 96), 0, PrecisionT::Precision{0, 16, 0} /**/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[((((x256(((((tir.shift_right(ax0.ax1.fused.ax2.outer.outer.fused, 1)*3840) + (ry*3840)) + (tir.bitwise_and(ax0.ax1.fused.ax2.outer.outer.fused, 1)*1792)) + (ax2.outer.inner*256))) + ((let rmod = (ramp(0, 1, 256) % x256(128)) in (let rdiv = (ramp(0, 1, 256)/x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rdiv, (rdiv - x256(1)))))*x256(128))) + x256((rx*128))) + x256((rc.outer*8))) + x256(rc.inner))]*/);
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((((ry*49152) + (rx*16384)) + (rc.outer*1024)) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
                sys->sendRequest(request);
              }
              {
            ...
            for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
              {
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((((ry*196608) + (rx*65536)) + (rc.outer*512)) + (rc.inner*256)), 1, 256)]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowMul_CRAM_RF);
                ...
                request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp(((((ry*196608) + (rx*65536)) + (rc.outer*512)) + (rc.inner*256)), 1, 256)]*/);
                request.addOperand(ax0_ax1_fused_ax2_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[((((((((ax0.ax1.fused.ax2.outer.fused/7)*4096) + (ry*4096)) + ((ax0.ax1.fused.ax2.outer.fused % 7)*512)) + (ax2.inner*256)) + (rx*256)) + (rc.outer*2)) + rc.inner)]*/);
                sys->sendRequest(request);
              }
              {
                Request request(Request::Type::RowAdd);
        ...
        for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
          {
            ...
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(x256(((rc.outer*512) + (rc.inner*128))) + (let rmod = (ramp(0, 1, 256) % x256(128)) in select(((x256((bool)1) && (x256(0) <= rmod)) || (x256((bool)0) && (rmod <= x256(0)))), rmod, (rmod + x256(128)))))]*/);
            sys->sendRequest(request);
          }
          {
            Request request(Request::Type::RowAdd);
          ...
          for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
            {
              Request request(Request::Type::RowLoad);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 0), 0, PrecisionT::Precision{0, 8, 0} /*DRAM*/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((((ry*393216) + (rx*131072)) + (rc.outer*1024)) + (rc.inner*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowMul_CRAM_RF);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((((ry*393216) + (rx*131072)) + (rc.outer*1024)) + (rc.inner*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
              request.addOperand(ax0_ax1_fused_ax2_fused_ax3_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((ax0.ax1.fused.ax2.fused.ax3.outer.fused/14)*7680) + (ry*3840)) + (tir.shift_right((ax0.ax1.fused.ax2.fused.ax3.outer.fused % 14), 1)*512)) + (rx*256)) + (rc.outer*2)) + rc.inner)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
      ...
      for (int32_t rc_inner = 0; rc_inner < 2; ++rc_inner) {
        {
          Request request(Request::Type::RowMul_CRAM_RF);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused_ax3_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((rc.outer*1024) + (rc.inner*512)) + (tir.bitwise_and(ax0.ax1.fused.ax2.fused.ax3.outer.fused, 1)*256)), 1, 256)]*/);
          request.addOperand(ax0_ax1_fused_ax2_fused_ax3_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(((((ax0.ax1.fused.ax2.fused.ax3.outer.fused/14)*7168) + (tir.shift_right((ax0.ax1.fused.ax2.fused.ax3.outer.fused % 14), 1)*512)) + (rc.outer*2)) + rc.inner)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
          ...
          for (int32_t rx = 0; rx < 3; ++rx) {
            {
              Request request(Request::Type::RowLoad);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 0), 0, PrecisionT::Precision{0, 8, 0} /*DRAM*/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((ry*98304) + (rx*32768)) + (rc.outer*256)), 1, 256)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowMul_CRAM_RF);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((((ry*98304) + (rx*32768)) + (rc.outer*256)), 1, 256)]*/);
              request.addOperand(ax0_ax1_fused_ax2_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*PaddedInput[(((((((ax0.ax1.fused.ax2.outer.fused/7)*7424) + (ry*3712)) + ((ax0.ax1.fused.ax2.outer.fused % 7)*512)) + (ax2.inner*256)) + (rx*128)) + rc.outer)]*/);
              sys->sendRequest(request);
            }
            {
              Request request(Request::Type::RowAdd);
    ...
    for (int32_t ax2_inner = 0; ax2_inner < 2; ++ax2_inner) {
      // cram-array axis
      {
        ...
        void* _2 = (void*) "Conv2dOutput.rf[ramp((rc.outer*256), 1, 256)] = x256(0)/*skip-init*/";
        {
          Request request(Request::Type::RowMul_CRAM_RF);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 80), 0, PrecisionT::Precision{0, 16, 0} /**/);
          request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_outer_fused, 0, 64), 0, PrecisionT::Precision{0, 8, 0} /*placeholder[ramp((rc.outer*256), 1, 256)]*/);
          request.addOperand(ax0_ax1_fused_ax2_outer_fused * 32, 0, PrecisionT::Precision{0, 8, 0} /*placeholder[(((((ax0.ax1.fused.ax2.outer.fused/7)*7168) + ((ax0.ax1.fused.ax2.outer.fused % 7)*512)) + (ax2.inner*256)) + rc.outer)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
