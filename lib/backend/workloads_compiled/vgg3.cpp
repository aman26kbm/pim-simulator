...
int32_t vgg3(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused_outer_outer = 0; ax0_ax1_fused_ax2_fused_outer_outer < 40; ++ax0_ax1_fused_ax2_fused_outer_outer) {
    for (int32_t ax0_ax1_fused_ax2_fused_outer_inner = 0; ax0_ax1_fused_ax2_fused_outer_inner < 40; ++ax0_ax1_fused_ax2_fused_outer_inner) {
      // cram-array axis
      {
        ...
        // cram-array axis
        {
          ...
          for (int32_t ry = 0; ry < 3; ++ry) {
            for (int32_t rx = 0; rx < 3; ++rx) {
              int32_t _11 = ax0_ax1_fused_ax2_fused_outer_outer * 80;
        ...
        #undef max
          int32_t _17 = ax0_ax1_fused_ax2_fused_outer_outer * 80;
        ...
        int32_t _22 = ax0_ax1_fused_ax2_fused_outer_outer * 80;
        int32_t _23 = ax0_ax1_fused_ax2_fused_outer_inner * 2;
        int32_t _24 = _22 + _23;
        int32_t _25 = _24 + ax0_ax1_fused_ax2_fused_inner;
        bool _26 = _25 < 3136;
        if (_26) {
          int32_t _27 = ax0_ax1_fused_ax2_fused_outer_outer * 40;
  ...
  for (int32_t ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 40; ++ax0_ax1_fused_ax2_fused_outer) {
    for (int32_t ax0_ax1_fused_ax2_fused_inner1 = 0; ax0_ax1_fused_ax2_fused_inner1 < 20; ++ax0_ax1_fused_ax2_fused_inner1) {
      ...
      for (int32_t rv0 = 0; rv0 < 2; ++rv0) {
        for (int32_t rv1 = 0; rv1 < 2; ++rv1) {
          // cram-array axis
          {
            ...
            for (int32_t ry1 = 0; ry1 < 3; ++ry1) {
              for (int32_t rx1 = 0; rx1 < 3; ++rx1) {
                int32_t _32 = ax0_ax1_fused_ax2_fused_outer * 20;
          ...
          #undef max
            int32_t _36 = ax0_ax1_fused_ax2_fused_outer * 20;
          ...
          int32_t _39 = ax0_ax1_fused_ax2_fused_outer * 20;
      ...
      int32_t _42 = ax0_ax1_fused_ax2_fused_outer * 20;
