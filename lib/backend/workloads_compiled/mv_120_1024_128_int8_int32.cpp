...
int32_t mv_120_1024_128_int8_int32(System *sys) {
  void* _1 = nullptr;
      ...
      #undef max
        {
          ...
          request.addOperand(sys->getAddress(x_outer_outer, 0, 20), 128, PrecisionT::Precision{0, 32, 0} /*c.global[ramp(0, 1, 128)]*/);
          request.addOperand(sys->getAddress(x_outer_outer, 0, 0), 128, PrecisionT::Precision{0, 32, 0} /*c.global.rf[ramp((k.outer.v*128), 1, 128)]*/);
          sys->sendRequest(request);
        }
        {
          Request request(Request::Type::RowAdd);
          request.addOperand(sys->getAddress(x_outer_outer, 0, 20), 128, PrecisionT::Precision{0, 32, 0} /**/);
          request.addOperand(sys->getAddress(x_outer_outer, 0, 20), 128, PrecisionT::Precision{0, 32, 0} /*c.global[ramp(0, 1, 128)]*/);
          request.addOperand(sys->getAddress(x_outer_outer, 0, 0), 128, PrecisionT::Precision{0, 32, 0} /*c.global.rf[ramp((k.outer.v*128), 1, 128)]*/);
          sys->sendRequest(request);
        }
...
static __attribute__((unused)) Registry::Entry &_mv_120_1024_128_int8_int32__ = pimsim::registerFunc("mv_120_1024_128_int8_int32", mv_120_1024_128_int8_int32);
