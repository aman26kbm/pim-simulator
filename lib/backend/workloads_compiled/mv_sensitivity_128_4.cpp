...
int32_t mv_sensitivity_compiled_128_4(System *sys) {
  void* _1 = nullptr;
...
static __attribute__((unused)) Registry::Entry &__mv_sensitivity_compiled_128_4__ = pimsim::registerFunc("mv_sensitivity_compiled_128_4", mv_sensitivity_compiled_128_4);
