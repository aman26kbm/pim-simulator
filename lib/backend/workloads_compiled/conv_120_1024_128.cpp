...
int32_t conv_120_1024_128(System *sys) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 98; ++ax0_ax1_fused_ax2_fused) {
    // cram-array axis
    {
          ...
          for (int32_t rx = 0; rx < 3; ++rx) {
            {
              ...
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 0), 512, PrecisionT::Precision{0, 8, 0} /*DRAM*/);
              request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 0), 512, PrecisionT::Precision{0, 8, 0} /*x[(((((((ax0.ax1.fused.ax2.fused/49)*20736) + (((ax0.ax1.fused.ax2.fused % 49)/7)*2304)) + (ry*2304)) + (rx*256)) + ((ax0.ax1.fused.ax2.fused % 7)*256)) + rc)]*/);
      ...
      void* _3 = (void*) "Conv2dOutput.repl.global[ramp(0, 1, 128)] = x128(0)/*skip-init*/";
