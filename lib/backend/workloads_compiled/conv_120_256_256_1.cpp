...
int32_t conv_120_256_256_1(System *sys) {
  void* _1 = nullptr;
        ...
        for (int32_t rx = 0; rx < 3; ++rx) {
          {
            ...
            request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 0), 256, PrecisionT::Precision{0, 8, 0} /*x[((((((ax0.ax1.fused.ax2.fused/7)*2304) + (ry*2304)) + (rx*256)) + ((ax0.ax1.fused.ax2.fused % 7)*256)) + rc.outer)]*/);
    ...
    #undef max
      {
        ...
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 32), 256, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.repl.global[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 0), 256, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
        sys->sendRequest(request);
      }
      {
        Request request(Request::Type::RowAdd);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 32), 256, PrecisionT::Precision{0, 32, 0} /**/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 32), 256, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.repl.global[ramp(0, 1, 256)]*/);
        request.addOperand(sys->getAddress(ax0_ax1_fused_ax2_fused, 0, 0), 256, PrecisionT::Precision{0, 32, 0} /*Conv2dOutput.rf[ramp((rc.outer.v*256), 1, 256)]*/);
        sys->sendRequest(request);
      }
...
static __attribute__((unused)) Registry::Entry &_conv_120_256_256_1__ = pimsim::registerFunc("conv_120_256_256_1", conv_120_256_256_1);
