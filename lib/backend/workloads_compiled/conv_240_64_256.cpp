          ...
          for (int32_t rc_inner = 0; rc_inner < 4; ++rc_inner) {
            {
              ...
              request.addOperand(ax0_ax1_fused_ax2_fused * 32, 16384, PrecisionT::Precision{0, 8, 0} /*x[((((((((ax0.ax1.fused.ax2.fused/49)*20736) + (((ax0.ax1.fused.ax2.fused % 49)/7)*2304)) + (ry*2304)) + (rx*256)) + ((ax0.ax1.fused.ax2.fused % 7)*256)) + (rc.outer*4)) + rc.inner)]*/);
