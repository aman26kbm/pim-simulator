...
int32_t vgg_bnn_13_256_512(System *sys,std::string param_file) {
  void* _1 = nullptr;
      ...
      for (int32_t ry = 0; ry < 3; ++ry) {
        for (int32_t rx = 0; rx < 3; ++rx) {
          ...
          }
          {
            ...
            request.addOperand(sys->getAddress(0, 0, 0), 0, PrecisionT::Precision{0, 1, 0} /*DRAM*/);
            request.addOperand(sys->getAddress(0, 0, 16), 0, PrecisionT::Precision{0, 1, 0} /*kernel[ramp(((((ry*393216) + (rx*131072)) + (rc.outer*512)) + (ff.outer*256)), 1, 256)]*/);
            sys->sendRequest(request);
          }
          {
...
static __attribute__((unused)) Registry::Entry &_vgg_bnn_13_256_512__ = pimsim::registerFunc("vgg_bnn_13_256_512", vgg_bnn_13_256_512);
