...
f_fig = open(os.path.join(input_file_dir,'04_upload_ablation_cycle_figure.csv'), 'w', encoding='UTF8', newline='')
writer = csv.writer(f_fig)
# write the header
writer.writerow(header)

assert os.path.isfile(os.path.join(os.getcwd(), input_file_dir, '03_chart_breakdown_avg.csv')), "chart_breakdown_avg.csv does not exist. Run collect_stats.py and generate_chart_data.py first."
